...
int main(int argc, char ** argv) {
   ...
   RUN(test_hiddev_report_type_name);
   RUN(test_hid_field_locator_lifecycle);
   RUN(test_free_hid_field_locator_null_safe);
   RUN(test_report_hid_field_locator_null_safe);
