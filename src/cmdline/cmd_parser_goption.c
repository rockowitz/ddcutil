...
//    {"trace",      '\0', 0, G_OPTION_ARG_STRING,       &tracework,            "Trace classes",  "comma separated list" },
      ...
      {"s1",      '\0', 0,  G_OPTION_STRING,       &parsed_cmd->s1,  "Special string 6",  "string"},
      {"s2",      '\0', 0,  G_OPTION_STRING,       &parsed_cmd->s2,  "Special string 6",  "string"},
      {"s3",      '\0', 0,  G_OPTION_STRING,       &parsed_cmd->s3,  "Special string 6",  "string"},
      {"s4",      '\0', 0,  G_OPTION_STRING,       &parsed_cmd->s4,  "Special string 6",  "string"},
      {NULL},
   };
