...
#ifdef UNUSED
Error_Info *          lock_display2(Display_Lock_Record * dlr, Display_Lock_Flags flags);
Error_Info *          unlock_display2(Display_Lock_Record * dlr);
#endif
...
void                  reset_display_locks_table();
