...
void     drd_set_default_max_tries(Display_Retry_Operation type_id, uint16_t new_maxtries);
void     drd_set_initial_display_max_tries( Display_Retry_Operation type_id, uint16_t new_maxtries);
void     drd_set_display_max_tries( Display_Retry_Operation type_id, uint16_t new_maxtries);
uint16_t drd_get_display_max_tries( Display_Retry_Operation type_id);
...
Global_Maxtries_Accumulator drd_get_all_displays_maxtries_range(Display_Retry_Operation typeid);
...
void drd_record_cur_display_successful_tries(Display_Retry_Operation type_id, int tryct);
void drd_record_cur_display_failed_max_tries(Display_Retry_Operation type_id);
void drd_record_cur_display_failed_fatally(Display_Retry_Operation type_id);
int get_display_total_tries_for_all_types_by_data(Per_Display_Data  * data);
#endif
void report_display_try_typed_data_by_data(
      Display_Retry_Operation     try_type_id,
